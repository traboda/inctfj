...
const YearlyLeaderboard = ({ data }: YearlyLeaderboard) => {
    ...
    <div className="py-6">
        <div className="py-2">
            ...
            <p className="text-lg opacity-80 mb-3">
               The InCTF Junior {data.year} champions
            </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">{data.results.champions.map((c, index) =>
    ...
    <div className="py-6">
        <div className="py-2">
            ...
            <p className="text-lg opacity-80 mb-3">
                The top 10 finalists of InCTF Junior {data?.year}

            </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">{data.results.top10.map((c, index) =>
            <div className="p-4 bg-white rounded-lg border" key={shortid.generate()}>
                <Fade up delay={index*250}>
                    <ChampionCard {...c} />
                </Fade>
    ...
    <div className="py-6">
        <div className="py-2">
            ...
            <p className="text-lg opacity-80 mb-3">
                The top Women Achievers of InCTF Junior {data?.year}
            </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">{data.results.topWomen.map((c, index) =>
            <div className="p-4 bg-white rounded-lg border" key={shortid.generate()}>
                <Fade up delay={index*250}>
                    <ChampionCard {...c} />
                </Fade>
