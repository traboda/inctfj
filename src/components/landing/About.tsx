        ...
        <div className="rounded-lg p-2 bg-blue-100">
          <div className="flex flex-wrap items-center">
            ...
            <div className="md:w-1/5 flex items-center md:my-0 my-3 md:px-0 justify-end">
              <a href="/discord" className="bg-primary px-4 rounded-lg text-white mb-0 py-3">
                Join Discord Now 
                {' '}
      ...
      <div className="flex flex-wrap mx-0">
        <div className="w-full md:w-2/3 p-2">
          ...
          {data.LandingDescINCTF.map((item, index) => (
            <p className="mb-2 text-justify text-base md:text-lg w-[720px] max-w-full" key={index}>
              {item}
            </p>
          ))}
        </div>
        <div className="md:w-1/3 flex justify-start items-center p-2">
          <ul className="flex flex-col text-lg lg:text-xl font-semibold gap-3">
