        ...
        <div className="header-container">
            <div style={{ width: '100%' }}>
                <div className="row mx-0">
                    <div className="col-md-8 col-lg-7 px-4 py-5 mt-3 mt-md-0 p-md-5">
                        <Pulse>
                            <h1>
                    ...
                    <div className="col-md-4 col-lg-5 p-1 p-md-3">
                        <iframe
                            className="w-100 border-0"
                            style={{ height: '65vh', overflow: 'auto' }}
                            src="https://beta.traboda.com/contest/inctfj-21-lr/reg-frame?utm_source=ssi"
                        />
                    </div>
                </div>
