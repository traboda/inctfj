...
const CTFPedagogy = () => (
    <div id="ctf-pedagogy">
        <div>
            ...
            <h3>
                It’s probably among the best pedagogy for learning, especially for beginner students to learn complex concepts.
            </h3>
        </div>
        <div>
            <h3>CTFs are very popular world-wide</h3>
            <div>
                <div>
        ...
        <div>
            ...
            <div>
                In Capture-The-Flag (CTF) game format, the players are tasked to do some activity, upon completion
                they receive a flag which they submit as proof of work.
            </div>
            <div>
                In our CTFs, these challenges usually involve learning some cybersecurity topics, tools & exploiting
                some vulnerabilities, hands-on using their critical thinking & problem-solving skills.
            </div>
            <div>
                Challenges present scenarios that make students learn fundamental concepts in secure programming,
